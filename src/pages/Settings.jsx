...
const Settings = ({ user, setUser }) => {
  ...
  const handleSaveChanges = () => {
    let newErrors = {};
    if (!formData.firstName.trim()) newErrors.firstName = 'Please fill in first name';
    if (!formData.lastName.trim()) newErrors.lastName = 'Please fill in last name';
  ...
  const handleUpdatePassword = () => {
    ...
    if (!formData.oldPassword) newErrors.oldPassword = 'Please enter old password';
